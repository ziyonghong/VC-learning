========================================================================
    WIN32 应用程序：7.9非模式对话框 项目概述
========================================================================

应用程序向导已为您创建了此 7.9非模式对话框 应用程序。

本文件概要介绍组成 7.9非模式对话框 应用程序的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 7.9非模式对话框.pch 的预编译头 (PCH) 文件和
